...
endpoints. Contact options are listed on https://transitous.org (Matrix room / email /
GitHub). Send this from your own account; edit freely.
...
It would call `api.transitous.org` directly from the phone:
...
request cap (≤ 10 per search, most searches 2–4). The app links to
